 ...
 */
 ...
 public class Map_1 {
   ...
   /*
    * Modify and return the the given map as follows: for this problem the map may or may not contain
   ...
   public static Map<String, String> mapAB4(Map<String, String> map) {
      if (map.get("a") != null && map.get("b") != null) {
         if (map.get("a").length() == map.get("b").length()) {
            ...
            String value = map.get("a").length() > map.get("b").length() ? map.put("c", map.get("a")) : map.put("c", map.get("b")); 
         }
      } 
      return map;
   }
   ...
   public static void main(String[] args) {
      ...
      map.put("c", "cat");
      map.put("d", "dog");
      System.out.println(mapAB4(map).toString());
   }
 }
